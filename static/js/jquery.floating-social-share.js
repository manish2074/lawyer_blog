...
(function($, window, document, undefined) {
          ...
          if (value === k) {
            var $icon = $("<i>", { class: "margin-top-5 fa fa-" + value }),
              ...
              $component = $("<a>", {
                ...
                .attr("href", _href)
                .attr("title", base.settings.text + value)
                .append($icon);
  ...
  var places = ["content-left", "top-left", "top-right"],
    networks = {
      ...
      facebook: {
        className: "facebook",
        url: "https://www.facebook.com/shraddha.bhattarai.399"
      },
      instagram: {
        className: "instagram",
        url: "https://www.instagram.com/shraddha1572017/"
      },
      "google-plus": {
      ...
      pinterest: {
        className: "pinterest",
        url:
          "https://pinterest.com/pin/create%2Fbutton/?url={url}&description={description}&media={media}"
      },
      reddit: {
        className: "reddit",
  ...
  function setMobileCss(objects) {
    ...
    $.each(objects, function() {
      if (w < 961) $(this).css("width", 100 / objects.length + "%");
